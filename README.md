...
個人で開発・使用しているユーザースクリプトのレポジトリです。すべて無保証で提供されます。

Firefox上のViolentmonkeyで動作を確認しています。他の環境でも動くと思いますが、分かりません。

## Amazon Privacy Protector

どちらかというとUserCSS。amazon.co.jp上で、マウスカーソルを合わせたときのみ本名やメールアドレスが映るようにします。
...
私が通い始めた土浦自動車学校の、管理用ウェブサイトで使うためのもの。一部はChatGPTによって生成されています。
